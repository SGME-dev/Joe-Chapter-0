...
func split_by_x_and_z():
	...
	var groups = {
		"Foot":      {"min_node": $Marker4D,  "max_node": $Marker4D4},
		"Shin":      {"min_node": $Marker4D2,  "max_node": $Marker4D11},
		"Thigh":     {"min_node": $Marker4D12, "max_node": $Marker4D3},
		"Hand":      {"min_node": $Marker4D5, "max_node": $Marker4D6},
		"Forearm":   {"min_node": $Marker4D9, "max_node": $Marker4D7},
		"Upperarm":  {"min_node": $Marker4D10, "max_node": $Marker4D8}
	}
